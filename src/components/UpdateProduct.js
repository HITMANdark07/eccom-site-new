...
export const UpdateProducts = ({history,match:{params:{productID}}}) => {
    ...
    const handleUpdateProducts=(e)=>{
        ...
        if(image===null){
            fs.collection("Products").doc(productID).update({
                ...
                setImageError("Unable to update Products");
            })
        }else{
    ...
    return (
        <div className='container'>
            ...
            <form autoComplete="off" className='form-group' onSubmit={handleUpdateProducts}>
